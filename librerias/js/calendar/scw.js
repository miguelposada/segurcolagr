...
//     http://www.tarrget.info/calendar/scw.htm#examples-demo
...
// SE PUSIERON LOS AÑOS PARA QUE MUESTRE 70 ANTES DE LA ACTUAL - MODIFICADO POR MIGUEL ANTONIO POSADA DICIEMBRE 15 2011
   // var scwBaseYear        = scwDateNow.getFullYear()-70;

    // How many years do want to be valid and to show in the drop-down list?

    var scwDropDownYears   = 70;
    ...
    function scwSetDefaultLanguage()
        {try
            ...
            {// Español modificado por miguel 15-12-2011
             scwToday               = 'Hoy:';
                scwClear               = 'Limpiar';
                ...
                scwRangeDisablingError = ['Error ',' deberia consistir de dos elementos.'];
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #019AFF;}'  +
            '/* Drag Handle */'                                         +
